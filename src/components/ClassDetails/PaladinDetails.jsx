...
export default async function PaladinDetails({ styles, classChoice }) {
  const classQuery = (
    await db.query(`SELECT * FROM dd_classes WHERE id = $1`, [14])
  ).rows;
        ...
        <div className={styles.class_showcase_stats}>
          ...
          <div className={styles.showcase_stat}>
            ...
            <div className={styles.showcase_bar_bg}>
              <div
                className={`${styles.showcase_bar} ${styles.paladin_gradient} w-72/100`}
              />
            </div>
          </div>
          <div className={styles.showcase_stat}>
            ...
            <div className={styles.showcase_bar_bg}>
              <div
                className={`${styles.showcase_bar} ${styles.paladin_gradient} w-70/100`}
              />
            </div>
          </div>
          <div className={styles.showcase_stat}>
            ...
            <div className={styles.showcase_bar_bg}>
              <div
                className={`${styles.showcase_bar} ${styles.paladin_gradient} w-60/100`}
              />
            </div>
          </div>
        </div>
